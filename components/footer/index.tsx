...
import { siteConfig, templateDomain, appDomain } from '@/config/site';
import Link from 'fumadocs-core/link';
import SealosSticky from '../ui/sealos-sticky';
...
const FooterLink: React.FC<FooterLinkProps> = ({
  ...
  <Link
    href={href}
    className={cn(
      'hover:underline-decoration-4 hover:underline-color-[#146DFF] text-[#A1A1AA] font-medium hover:text-[#146DFF] hover:underline hover:underline-offset-4',
      className,
    )}
  >
    {children}
...
const Footer = async ({
  ...
  return (
    <div className="relative w-full bg-black pt-20">
      <div className="flex flex-col items-start justify-between px-16 text-sm lg:flex-row">
        <div className="flex w-full flex-col items-center lg:items-start">
          <h2 className="footer-title text-[32px] font-medium leading-[48px] mb-4 font-['Geist']">
            <div className="text-white">Ready to Stop Configuring and</div>
            <div className="footer-title-gradient">Start Creating?</div>
          </h2>
          ...
          <Link
            href={appDomain}
            className="footer-cta-button inline-flex items-center gap-2 px-4 py-2 rounded-[54px] font-medium transition-colors"
          >
            <span className="footer-button-text">Start Building for Free</span>
            <svg className="footer-button-arrow" width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path d="M1.33333 6.00065H10.6667M10.6667 6.00065L6 1.33398M10.6667 6.00065L6 10.6673" stroke="#18181B" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </Link>
        </div>
        ...
        <div className="mt-10 hidden w-full grid-cols-1 gap-4 text-center sm:grid sm:grid-cols-2 sm:gap-y-8 lg:mt-0 lg:grid-cols-4 lg:items-start lg:gap-10 lg:text-left">
          <FooterLinkColumn>
            <div className="text-base font-semibold text-white uppercase hover:text-white hover:no-underline">
      ...
      <SealosSticky
        ...
        <div className="flex flex-col items-center gap-2 px-16 pt-4 pb-4 text-center text-xs lg:flex-row lg:items-center lg:justify-between lg:gap-0">
        {/* Legal links */}
