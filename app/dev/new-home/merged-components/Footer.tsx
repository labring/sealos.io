...
const Footer = async ({ lang = 'en' }: FooterProps) => {
  ...
  return (
    <div className="relative w-full bg-black pt-0">
      ...
      {/* Sealos Background + Sticky Legal Bar */}
        ...
        <SealosSticky
          ...
          bar={
            <>
              ...
              ></div>
              <div className="relative z-10 container flex flex-col items-center gap-2 px-16 py-4 text-center text-xs lg:flex-row lg:items-center lg:justify-between lg:gap-0">
                {/* Legal links */}
                <div className="order-1 flex flex-wrap justify-center gap-2 font-normal text-zinc-400 lg:order-none">
                ...
                {/* Copyright */}
                <div className="order-3 font-normal text-zinc-400 lg:order-none lg:px-4">
                  {footerLinks.copyright}
                </div>
                {/* Social icons */}
                <div className="order-2 flex justify-center gap-4 lg:order-none">
                  <a
                    href="https://github.com/labring/sealos"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-zinc-600/35 text-white transition-colors hover:bg-zinc-400/60"
                    title="GitHub"
                  >
                    <GithubIcon />
                  </a>
                  ...
                  <a
                    href="https://twitter.com/sealosio"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-zinc-600/35 text-white transition-colors hover:bg-zinc-400/60"
                    title="Twitter"
                  ...
                  <a
                    href="https://www.youtube.com/@sealos"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
