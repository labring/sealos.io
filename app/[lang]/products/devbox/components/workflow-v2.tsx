    ...
    timeline: [
      {
        ...
        description: 'Choose your framework, click create. DevBox instantly provisions a cloud development environment with all dependencies pre-installed.',
        comparison: {
      ...
      },
      {
        ...
        description: 'Connect VS Code, Cursor, or JetBrains directly to your cloud environment. Code runs in the cloud while you work from any device.',
        comparison: {
      ...
      },
      {
        ...
        description: 'Need changes? Update code in DevBox, create new release, deploy update. The entire cycle takes minutes, not hours.',
        comparison: {
      ...
      },
      {
        ...
        description: 'With DevBox handling environments, packaging, and deployment, you focus purely on writing great code and building features.',
        comparison: {
  ...
  'zh-cn': {
    ...
    timeline: [
      ...
      },
      {
        ...
        icon: Code,
        title: '使用您喜欢的 IDE 编码',
        description: '将 VS Code、Cursor 或 JetBrains 直接连接到您的云环境。代码在云中运行，而您可以从任何设备工作。',
        comparison: {
    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-0 bottom-0 hidden w-0.5 -translate-x-1/2 bg-gradient-to-b from-blue-200 via-purple-200 to-pink-200 lg:block" />
                ...
                <AnimateElement key={index} type="slideUp" delay={index * 0.1}>
                  <div className={cn(
                    ...
                    <div className={cn(
                      ...
                      <div className={cn(
                        "relative rounded-2xl bg-white p-8 shadow-xl overflow-hidden",
                        "border-2 border-gray-100 hover:border-blue-200 transition-colors"
                      )}>
                        {/* Time Badge */}
                        <div className={cn(
                        ...
                        <div className={cn(
                          "mb-4 flex items-center gap-3",
                          isEven ? "lg:justify-end lg:flex-row-reverse" : ""
                        )}>
                    ...
                    {/* Timeline dot */}
                    <div className="relative z-10 my-8 lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:my-0">
        ...
        <AnimateElement type="slideUp" delay={0.8}>
          <div className="relative mt-20 rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 p-12 text-center text-white overflow-hidden">
            <Particles
