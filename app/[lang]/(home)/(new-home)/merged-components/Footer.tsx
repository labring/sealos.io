  ...
  return (
    ...
    >
      ...
      <div className="relative w-full pt-0">
          ...
          <div className="mt-10 w-full grid grid-cols-4 gap-6 items-start text-left lg:mt-0 lg:grid-cols-4 lg:gap-10">
            {[
              ...
              <div key={idx} className="cib flex flex-col justify-center gap-4">
                <div className="font-semibold text-white uppercase text-[clamp(14px,calc(14px+2*(100vw-375px)/265),16px)]">
                  {category.title}
                </div>
        ...
        <div className="container grid grid-cols-1 grid-rows-3 items-center px-0 py-4 text-sm border-t border-gray-600 mt-[30px] sm:grid-cols-2 sm:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1">
