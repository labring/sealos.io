    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-20">
        <div className="max-w-4xl text-center">
          ...
          >
            From &apos;git push&apos; to a public URL — without &apos;git
            push&apos;.
          </GradientText>
          <p className="mx-auto mt-7 max-w-2xl text-base leading-7 text-zinc-400">
            Connect GitHub, pick a repository, and let the agent prepare the
            deployment path while the workspace stays visible.
          </p>
        </div>
