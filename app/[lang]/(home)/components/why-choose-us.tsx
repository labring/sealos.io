...
export default function WhyChooseUs({ lang = 'en' as languagesType }) {
  ...
  // Render function for advantages to avoid re-renders
  const renderAdvantages = () => {
    return t.advantages.map((advantage, index) => (
      <div
        key={index}
  ...
  // Render function for comparison table to avoid re-renders
  ...
  // Main content wrapped in Suspense for lazy-loaded AnimateElement
  const content = (
