  ...
  return (
    <div className="relative">
      ...
      <form
        ...
        className="bg-card/90 relative rounded-3xl border border-white/10 p-8 shadow-xl backdrop-blur-sm sm:p-10"
      >
        <div className="border-border/60 mb-8 border-b pb-6">
          <h2 className="text-foreground text-xl font-semibold">
            {content.form.detailTitle}
          </h2>
          <p className="text-muted-foreground mt-1 text-sm">
            {content.form.detailSubtitle}
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => {
                setFormData((prev) => ({
                  ...prev,
                  abuseType: value as AbuseTypeKey,
                }));
              }}
              required
            >
          ...
          <div>
            <label
              htmlFor="evidence"
              className="text-muted-foreground mb-2 block text-sm font-semibold"
            >
          ...
          <div className="pt-4">
            <button
              ...
              className={cn(
                ...
                'focus:ring-ring/50 focus:ring-4 focus:outline-none',
