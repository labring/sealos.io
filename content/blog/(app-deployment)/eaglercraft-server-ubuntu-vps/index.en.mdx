...
![Multiplayer server list showing the server entry at ws://192.168.0.228/ with the An EaglercraftX server message of the day. Captured September 16, 2026 on the test machine.](./images/server-list.webp)
