---
title: 'Claude Code Metrics Dashboard with Grafana: Setup Guide'
imageTitle: 'Claude Code Metrics Dashboard'
description: 'Track Claude Code metrics with Grafana, Prometheus, and OpenTelemetry. Compare Docker Compose vs. Sealos, launch faster, and monitor cost in minutes.'
date: 2025-12-12
tags:
  [
    'Claude Code',
