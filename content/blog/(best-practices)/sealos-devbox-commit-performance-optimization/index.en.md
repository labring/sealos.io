...
![DevBox Commit Performance Flame Graph Before Optimization](./images/devbox-commit-performance-flame-graph-before-optimization.png)
...
### Flame Graph: The Transformation

![DevBox Commit Performance Flame Graph After Optimization](./images/devbox-commit-performance-flame-graph-after-optimization.png)

The flame graphs tell the complete story. Where `doubleWalkDiff` once consumed 95% of CPU time, it has completely vanished. The remaining time is now spent on actual useful work: compressing and packaging the changed files.
