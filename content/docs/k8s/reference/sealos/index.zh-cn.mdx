...
- Sealos使用指南： 有关每个命令的详细信息，包括所有受支持的参数和子命令， 请参阅 [sealos](/docs/k8s/reference/sealos/commands/) 参考文档。
- 集群镜像:
  - [Rootfs集群镜像](/docs/k8s/reference/sealos/kubernetes-cluster-image)
  - [Application集群镜像](/docs/k8s/reference/sealos/app-cluster-image)
