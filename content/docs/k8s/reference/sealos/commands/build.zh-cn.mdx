...
- [基于镜像清单构建](/docs/k8s/operations/build-image/build-image-image-list)
- [基于部署清单构建](/docs/k8s/operations/build-image/build-image-manifests)
- [基于helm-charts构建](/docs/k8s/operations/build-image/build-image-helm-charts)
- [基于二进制构建](/docs/k8s/operations/build-image/build-image-binary)
- [基于go-template构建](/docs/k8s/operations/build-image/build-image-go-template)
- [基于exec和scp构建](/docs/k8s/operations/build-image/build-image-scp-exec)
