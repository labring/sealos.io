...
description: 'Build a Django 5.2 Task app, prepare Gunicorn, WhiteNoise, and PostgreSQL, then deploy it with Sealos Skills and verify a live create/read flow.'
